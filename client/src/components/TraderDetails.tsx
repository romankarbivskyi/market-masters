  ...
  return (
    <div className="flex w-full max-w-[600px] flex-col gap-3">
      ...
      <div className="flex flex-col gap-2 rounded-xl border border-zinc-700/60 bg-zinc-800/30 p-4">
        <span className="mb-1 text-sm font-medium text-zinc-300">Summary</span>
        ...
        <div className="flex items-center justify-between gap-1">
          <span className="text-xs font-medium text-zinc-400">UNREALIZED</span>
          <span className="text-xs font-medium">
        ...
        <div className="flex items-center justify-between gap-1">
          <span className="text-xs font-medium text-zinc-300">TOTAL PNL</span>
        ...
        <div className="flex w-full flex-col gap-2 rounded-xl border border-zinc-700/60 bg-zinc-800/30 p-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between">
              <span className="text-xs font-medium text-zinc-400">TOKENS</span>
              <span className="text-xs font-medium">
